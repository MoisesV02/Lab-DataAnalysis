...
B.pl.annotate(r"$K_\beta$", (28, 111), color='b')
B.pl.annotate(r"$K_\alpha$", (33, 340), color='b')
...
B.plot_exp(x = n, y = np.sin(peakAngles), dy = uY)
line = B.linefit(x = n, y = np.sin(peakAngles), yerr = uY)
